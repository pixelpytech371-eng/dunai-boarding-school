...
export default function HomeAchievementsPreview({ achievements, setPage, ourPride, studentAchievements,achievementsPreviewDesc, viewAllAchievements }: HomeAchievementsPreviewProps) {
